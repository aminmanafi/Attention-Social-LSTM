...
def train(args):
    ...
    if args.drive is True:
      prefix='drive/MyDrive/Amin-Manafi/social-lstm-master/'
      f_prefix = 'drive/MyDrive/Amin-Manafi/social-lstm-master'
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in range(dataloader.num_batches):
            ...
            for sequence in range(dataloader.batch_size):
                ...
                # Forward prop
                outputs, _, _ = net(x_seq, grid_seq, hidden_states, cell_states, PedsList_seq,numPedsList_seq ,dataloader, lookup_seq, attention_weights)
        ...
        if dataloader.additional_validation and (epoch) in validation_epoch_list:
            ...
            for batch in range(dataloader.num_batches):
                ...
                for sequence in range(dataloader.batch_size):
                    ...
                    ret_x_seq, loss = sample_validation_data(x_seq, PedsList_seq, grid_seq, args, net, lookup_seq, numPedsList_seq, dataloader,attention_weights)
...
###############################################################################
# Preparing data for get attention weights
