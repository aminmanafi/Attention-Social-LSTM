...
class DataLoader():
    ...
    def __init__(self,f_prefix, batch_size=5, seq_length=20, num_of_validation = 1, forcePreProcess=False, infer=False, generate = False):
        '''
        ...
        base_test_dataset = ['/data/test/biwi/biwi_eth.txt',
       		 	'/data/test/biwi/biwi_hotel.txt',
      			  '/data/test/crowds/crowds_zara01.txt',
                             '/data/test/crowds/crowds_zara02.txt',
                             '/data/test/stanford/students001.txt',
                             '/data/test/stanford/students003.txt']
        #base train files
        base_train_dataset = ['/data/train/biwi/biwi_hotel_train.txt',
        ...
        '/data/train/crowds/crowds_zara02_train.txt',
                              ...
                              '/data/train/stanford/students001_train.txt',
                              '/data/train/stanford/students003_train.txt',
                              '/data/train/stanford/uni_examples_train.txt']
        # dimensions of each file set
        self.dataset_dimensions = {'biwi':[720, 576], 'crowds':[720, 576], 'stanford':[595, 326], 'mot':[768, 576]}
        
        # List of data directories where raw data resides
        self.base_train_path = 'data_social-lstm/train/'
        self.base_test_path = 'data_social-lstm/test/'
        self.base_validation_path = 'data_social-lstm/validation/'
